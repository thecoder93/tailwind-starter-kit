...
This project was bootstrapped with Qwik CLI (https://qwik.dev/docs/getting-started/).
...
It correctly bundles Qwik in production mode and optimizes the build for the best performance.
...
You can learn more in the [Qwik documentation](https://qwik.dev/docs/getting-started/).

To learn Qwik, check out the [Qwik](https://qwik.dev/).



## Documentation
The documentation for the Qwik Profile Page is hosted at our <a href="#" target="_blank">website</a>.
...
We use GitHub Issues as the official bug tracker for the Qwik Profile Page. Here are some advices for our users that want to report an issue:

1. Make sure that you are using the latest version of the Qwik Profile Page. Check the CHANGELOG from your dashboard on our <a href="https://www.creative-tim.com/?ref=rpp-tsk-readme" target="_blank">website</a>.
